...
- Again, I don't know how is this supposed to work on Windows, other than a VM or WSL. **(With version 1.3+ Windows is supported! Tho 1.4 doesn't work on Linux for some reason.)**
## Dependencies
- C++ libraries
- Ffmpeg
